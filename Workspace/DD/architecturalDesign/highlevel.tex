...
\begin{itemize}
	\itemBold{Client} This is the mobile application used by the users. All the communication done by the client to the server are using the pattern Client-Server
